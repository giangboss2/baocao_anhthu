package project.anhthu.travelinvietnam_app.Adapter;
...
import project.anhthu.travelinvietnam_app.Activity.DetailActivity;
...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.ViewHolder> {
  ...
  //  DecimalFormat formatter;
    ...
    public void onBindViewHolder(@NonNull PopularAdapter.ViewHolder holder, int position) {
        ...
        int drawableResId = holder.itemView.getResources().getIdentifier(items.get(position).getPic(),"drawable"
    ...
    public class ViewHolder  extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            scoreTxt = itemView.findViewById(R.id.scrore);
